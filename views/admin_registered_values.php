<?php
	...
	$panAccount = get_option('rc_PanAccount');
...
<div style="padding-top: 10px;"><h style="font-weight:bold;">Advertiser name:</h></div>
<input type="text" style="width: 300px;" value="<?php echo $panAccount ?>" id="Savereg_login" disabled></input>
