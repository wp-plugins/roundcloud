<?php?><div>
	...
	<div class="rc_settings_container">
		<input type="checkbox" value="" id="rc_woocommerce"/>
	...
	<div class="rc_settings_container">
		<input type="checkbox" id="rc_integration_show_banner" value=""/>
		<h style='font-weight:bold;font-size: 16px;'>Site Monetization</h>
		<p>I am interested in the possibilities to monetize my site. I want to try the role of Publisher in the RoundCloud Network.</p>
	</div>
...
<script>
	...
	document.getElementById("rc_woocommerce").checked = <?php echo get_option('rc_woocommerce');?>;
	...
	document.getElementById("rc_integration_show_banner").checked = <?php echo get_option('rc_show_banner');?>;
